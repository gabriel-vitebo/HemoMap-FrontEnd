<template>
  <div>
    ...
    <!-- Elemento onde o script vai renderizar o chatbot -->
...
// Função para carregar o script uma única vez
function loadBotScript() {
  if (scriptLoaded.value) return

  const script = document.createElement('script')
  script.setAttribute ('src', 'https://xltw-api6-8lww.b2.xano.io/vault/4kRWyNwe/rh0JCk86x67O-LMWG86mxG-r-ns/RF2OPQ../chatbotWeb3.js')
  ...
  script.setAttribute('icon', 'https://xltw-api6-8lww.b2.xano.io/vault/4kRWyNwe/me1t6XZR9c6n0dnQSCm3hC6SuSo/AVlnHg../3+-+chat_redondo.json')

  document.body.appendChild(script)
  scriptLoaded.value = true
}

// Alternar visibilidade do bot
function toggleBot() {
  if (!scriptLoaded.value) {
    loadBotScript()
    // Dá um tempinho para o script carregar e renderizar o bot
    setTimeout(() => {
...
onMounted(() => {
  // Opcional: carregar script automaticamente
})
</script>
